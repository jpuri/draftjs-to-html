  ...
  */
  ...
  function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
    ...
    if (entity.type === 'IMAGE') {
      return "<img src=\"".concat(entity.data.src, "\" alt=\"").concat(entity.data.alt, "\" style=\"float:").concat(entity.data.alignment || 'none', ";height: ").concat(entity.data.height, ";width: ").concat(entity.data.width, "\"/>");
    }
