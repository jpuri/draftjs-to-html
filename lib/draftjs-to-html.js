(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('emoji-regex')) :
	typeof define === 'function' && define.amd ? define(['emoji-regex'], factory) :
	(global.draftjsToHtml = factory(global.emojiRegex));
}(this, (function (emojiRegex) { 'use strict';
...
function getInlineStyleSections(block, styles, start, end) {
  ...
  if (text.length > 0) {
    ...
    for (var i = start; i < end; i += 1) {
      var indexOffset = i + emojiOffset;
      var textChar = [text[indexOffset]];
      var _emoji = emojiIndex[indexOffset];

      if (_emoji) {
        textChar.push.apply(textChar, _toConsumableArray(_emoji.slice(1)));
        emojiOffset = emojiOffset + _emoji.length - 1;
      }

      if (i !== start && sameStyleAsPrevious(inlineStyles, styles, i)) {
        var _section$text;

        (_section$text = section.text).push.apply(_section$text, textChar);
