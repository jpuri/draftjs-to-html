(function (global, factory) {
  ...
  function getSectionMarkup(
    ...
    if (section.type === 'ENTITY') {
      ...
      // const stringWithoutHash = sectionText.substring(1);
      // console.log(stringWithoutHash)
      let strippedString = sectionText.replace(/[^\w\s]/gi, '')
      // console.log(strippedString)
      if (/\d/.test(strippedString)){
        return sectionText
      }

      const path = hashtagConfig.path+'/'+strippedString;
      // console.log(path)
      
      sectionText = "<a href=\"".concat(path, "\" class=\"wysiwyg-hashtag\">").concat(sectionText, "</a>");
    }
